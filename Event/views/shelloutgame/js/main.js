...
Mouse.prototype = {
    //地鼠型別,好,壞,好的被殺,壞的被殺
    mousetype: {
        "good": "https://img.eclife.com.tw/EDM/11007/mediashow2021/game/Gophers_b.png",
        "bad": "https://img.eclife.com.tw/EDM/11007/mediashow2021/game/Gophers_r.png",
        "goodkill": "https://img.eclife.com.tw/EDM/11007/mediashow2021/game/Gophers_b_02.png",
        "badkill": "https://img.eclife.com.tw/EDM/11007/mediashow2021/game/Gophers_r_02.png"
    },
    //初始化地鼠
    init: function(type) {
        type = type || "good";
        ...
        if (screen.width < 992) {
            this.mouse.style.cssText = "width:100px;height:159px;background:url('" + this.mousetype[type] + "') no-repeat;left:50%;transform: translateX(-50%);bottom:8px;position:absolute;margin:auto;cursor:pointer;";
            this.mouse.style.backgroundSize = "100%";
        } else {
            this.mouse.style.cssText = "width:146px;height:230px;background:url('" + this.mousetype[type] + "') no-repeat;left:50%;transform: translateX(-50%);bottom:13px;position:absolute;margin:auto;cursor:pointer;";
            this.mouse.style.backgroundSize = "100%";
        }
        //繫結地鼠被點選事件
